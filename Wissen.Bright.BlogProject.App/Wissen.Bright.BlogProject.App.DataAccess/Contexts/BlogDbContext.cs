    ...
    public class BlogDbContext : IdentityDbContext<AppUser, AppRole, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Article>().HasData(
                new Article() { Id = 1, Title = "C#.Net Introduction", Summary = "Visual Studio .Net ortamında C#.Net ile temel seviyeden (veri türleri, değişkenler, karar verme (if-else), döngüler, diziler) ileri düzeye (nesneye dayalı proglama (oop), collections, generic collections, linq) eğitim programı...", Content = "Visual Studio .Net ortamında C#.Net ile temel seviyeden (veri türleri, değişkenler, karar verme (if-else), döngüler, diziler) ileri düzeye (nesneye dayalı proglama (oop), collections, generic collections, linq) eğitim programı.", CategoryId = 1, UserId = 1, PictureUrl = "CSharp01.jpg" },
                new Article() { Id = 2, Title = "Entity Framework Core ile ORM", Summary = "Visual Studio .Net ortamında Entity Framework Core ORM teknolojisini kullanarak veritabanı yönetiminin en popüler yollarını gösteren eğitim programı...", Content = "Visual Studio .Net ortamında Entity Framework Core ORM teknolojisini kullanarak veritabanı yönetiminin en popüler yollarını gösteren eğitim programı.", CategoryId = 2, UserId = 2, PictureUrl = "EFCore01.jpg" },
