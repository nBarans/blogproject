    ...
    public partial class initAndSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 9, 24, 22, 57, 7, 142, DateTimeKind.Local).AddTicks(726), "C#.Net Introduction", false, "C#.Net Programming" },
                    { 2, new DateTime(2023, 9, 24, 22, 57, 7, 142, DateTimeKind.Local).AddTicks(749), "Entity Framework Core ile ORM teknolojileri", false, "Entity Framework Core" },
                    { 3, new DateTime(2023, 9, 24, 22, 57, 7, 142, DateTimeKind.Local).AddTicks(751), "Asp.Net Core Mvc ile Web Programlama", false, "Asp.Net Core Mvc" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Visual Studio .Net ortamında C#.Net ile temel seviyeden (veri türleri, değişkenler, karar verme (if-else), döngüler, diziler) ileri düzeye (nesneye dayalı proglama (oop), collections, generic collections, linq) eğitim programı.", new DateTime(2023, 9, 24, 22, 57, 7, 142, DateTimeKind.Local).AddTicks(974), false, "CSharp01.jpg", "Visual Studio .Net ortamında C#.Net ile temel seviyeden (veri türleri, değişkenler, karar verme (if-else), döngüler, diziler) ileri düzeye (nesneye dayalı proglama (oop), collections, generic collections, linq) eğitim programı...", "C#.Net Introduction", 1 },
                    { 2, 2, "Visual Studio .Net ortamında Entity Framework Core ORM teknolojisini kullanarak veritabanı yönetiminin en popüler yollarını gösteren eğitim programı.", new DateTime(2023, 9, 24, 22, 57, 7, 142, DateTimeKind.Local).AddTicks(980), false, "EFCore01.jpg", "Visual Studio .Net ortamında Entity Framework Core ORM teknolojisini kullanarak veritabanı yönetiminin en popüler yollarını gösteren eğitim programı...", "Entity Framework Core ile ORM", 2 },
                    { 3, 3, "Visual Studio .Net ortamında Asp.Net Core MVC ile temel düzeyden ileri seviyeye web programlama eğitim programı.", new DateTime(2023, 9, 24, 22, 57, 7, 142, DateTimeKind.Local).AddTicks(983), false, "Mvc01.jpg", "Visual Studio .Net ortamında Asp.Net Core MVC ile temel düzeyden ileri seviyeye web programlama eğitim programı.", "ASp.Net Core MVC ile Web Programlama", 1 }
                });
